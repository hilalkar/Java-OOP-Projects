...
//     System.out.println(Ata.a);         //Bu satır, Ata sınıfında tanımlanan static int a=3; değişkenine erişir ve değerini ekrana yazdırır. Bu değişken Ata sınıfının bir üyesi olduğu için Ata.a şeklinde erişim yapılır. Bu durumda a değişkeninin değeri olan 3 ekrana yazdırılır
...
//      new Torun();
  ...
  //          System.out.println(Torun.c);
    ...
    class Ata{
        ...
        }                 //dinamik alan nesne üretildiğinde çalışır
